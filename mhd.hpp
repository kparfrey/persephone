...
class MHD : public Physics<MHD>
{
    ...
    const real_t floor_pressure = 0.1;
...
inline void MHD::ConservedToPrimitive_(const real_t* const __restrict__ U, 
                                             real_t* const __restrict__ P,
                                       const int mem) const
{
    P[density] = U[density]; 
...
inline void MHD::PrimitiveToConserved_(const real_t* const __restrict__ P, 
                                             real_t* const __restrict__ U,
                                       const int mem) const
{
...
inline void MHD::WaveSpeeds_(const real_t* const __restrict__ P, 
                                   real_t* const __restrict__ c,
                             const int dir,
                             const int mem) const 
{
...
inline void MHD::Fluxes_(const real_t* const __restrict__ P, 
                               real_t (*__restrict__ F)[3],
                         const int mem) const
{
...
inline void MHD::DiffusiveFluxes_(const real_t* const __restrict__   P, 
...
inline void MHD::Floors_(real_t* const __restrict__ U, const int mem) const
{
    if (divB_subsystem_only)
        return;
    ...
    MHD::ConservedToPrimitive_(U, P, mem);
