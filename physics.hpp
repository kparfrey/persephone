...
class Physics
{
    ...
    EqnSystem system;
    inline static int Nfield; // Total number of fields
    inline static int Ncons;  // Number of conserved variables
    inline static int Nflux;  // Number of conserved variables to calculate fluxes for -- remove??
    string* variables;
